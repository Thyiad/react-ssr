...
type UITypes = 'success' | 'warning' | 'error' | 'info';
 ...
 */
export const toast = (msg: string, type: UITypes | 'loading' = 'success') => {
    // @ts-ignore
    message[type](msg);
};
 ...
 */
export const notify = (msg: string, subMsg = '', type: UITypes = 'success') => {
    // @ts-ignore
    notification[type]({
        message: msg,
        description: subMsg,
 ...
 * @param cb 确认回调
 */
export const alert = (msg: string, type: UITypes = 'info', content: string | ReactNode = '', cb?: () => void) => {
    // @ts-ignore
    Modal[type]({
        title: msg,
        content,
